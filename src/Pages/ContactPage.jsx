              ...
              <div className="space-y-8">
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-5">
                    ...
                    <p className="text-gray-600">Techistasolutions@gmail.com</p>
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-5">
                    ...
                    <p className="text-gray-600">Office No-131A</p>
                    <p className="text-gray-600">Sector-52,Madyamarg</p>
                    <p className="text-gray-600">Chandgrah-160019</p>
                  </div>
                </div>
              </div>              
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-xl p-10 border border-gray-100">
              ...
              <div className="flex space-x-4">
                {[
                  ...
                  <a 
                    key={index}
                    href="https://www.instagram.com/techista_solutions?utm_source=qr&igsh=MXB4Z2NucG9zZHE5MQ%3D%3D" 
